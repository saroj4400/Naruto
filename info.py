...
auth_channel = environ.get('AUTH_CHANNEL', '-1002370466536') # give your force subscribe channel id here else leave it blank
...
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', '+QQiRoIMObCcwZThl') # Support Chat Link Without https:// or @
...
VERIFY_SHORTLINK_URL = environ.get('VERIFY_SHORTLINK_URL', '2e282479e378bd3f2495b8243b4d96687167e464')
VERIFY_SHORTLINK_API = environ.get('VERIFY_SHORTLINK_API', 'softurl.in')
