...
auth_users = [int(user) if id_pattern.search(user) else user for user in environ.get('AUTH_USERS', '7364818327').split()]
...
auth_channel = environ.get('AUTH_CHANNEL', '-1002483654125') # give your force subscribe channel id here else leave it blank
